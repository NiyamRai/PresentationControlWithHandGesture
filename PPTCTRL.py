...
hands = mpHands.Hands()   #complete the initialization configuration of hands   '''Created By Niyam Rai'''
...
while True:
    ...
    if lmList != []:
        ...
        #Left Right                                     '''Created By Niyam Rai'''
        ...
        if  PP10<60 and PP5<50 and PP6<140 and PP8<120:
            if PP12>PP13:
                ...
                # '''Created By Niyam Rai'''
                keyboard.release(Key.down)
                time.sleep(0.3)
            continue


    # img = '''Created By Niyam Rai'''cv.resize(img, (412,333), interpolation=cv.INTER_CUBIC)
    cv.imshow('GESTURE PPT CTRL BY NIYAM',img) #Show the video 
